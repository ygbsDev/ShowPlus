...
#         #     registration_id="cw9cI9oZT8m32GnT/DxVQVn:APA91bFta5k8P1DBbAPu-FSaj4hSptlTOFndflnco27C8ubPW27qh55fv91paqHFgGsRpY0P3tCq3T6QnLkhSppimvJatRsk6n4-aIIggkUxcIq2ArsAfYb_XFOW2XTVeqTJpyM7IZEd",
...
def testttt333(request):
    try:
        ...
        data = json.loads(request.body.decode("utf-8"))
        # token = data['token']
        token = "cSvIPlMqoEmrhb2O4DSEoO:APA91bEemMJcMkaLx1YG7-hVePVgt6Q76GB41ET76_UoUxBshUWuiNemRfI0o-kobE9c7y8TxGyUGkpX-_mRZ_sKRcuCbxEgU22QDpKPugAWelkIBWiXmtoWpqmp-kB3LdVdqcRVGEKZ"
...
#         else:
#             text = "phone : " + phone + ", 회원가입 불가능"
#             ment = "\033[93m"+"phoneAuthCode WARNING -> "+text+"\033[0m"
#             print("["+str(datetime.now())+"] " + ment + '\033[0m')       
#             context = {'code':'1'}
#             return HttpResponse(json.dumps(context))     
...
#                     if userBlockListinfoCount == 0:
#                         comentPK = i.id
#                         Audition_CommentDeclarationinfoCount = Audition_CommentDeclaration.objects.filter(commentPK = comentPK).count() # 테스트용, 테스트 완료시 삭제 해야함
...
#         userinfoList = [{'username':username, 'nickName':nickName, 'profileIMG_path':profileIMG_path, 'AboutMe':AboutMe, 'grade':grade, 'allVideoCount':allVideoCount}]
